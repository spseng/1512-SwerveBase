...
public class Constants {
    ...
    public static class Drivetrain {
        ...
        public static final double MAX_DRIVE_SPEED_MPS = 4.8;
        ...
        public static final double MAX_TURING_SPEED = 6.8; // Radians per second
        ...
        // Turning PID
        public static final double STEER_KP = 2.8;
        public static final double STEER_KI = 0.0;
        public static final double STEER_KD = 0.0;
        public static final double STEER_FF = 1.0;
        ...
        public static final double MAX_DRIVE_ACCELERATION = 1000.0;
