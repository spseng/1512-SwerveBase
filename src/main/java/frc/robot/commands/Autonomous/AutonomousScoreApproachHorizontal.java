...
public class AutonomousScoreApproachHorizontal extends Command {
    ...
    public AutonomousScoreApproachHorizontal(Drivetrain drivetrain, String cameraName) {
    ...
    public void execute() {
        ...
        _drivetrain.setVelocity(new ChassisSpeeds(0, vy, omega));
    }

    @Override
    public boolean isFinished() {
        return ((_driveYController.atSetpoint() && _rotationController.atSetpoint()) || !_visionProcessor.isTargetinSight()); // This command never finishes on its own, it needs to be interrupted
    }
